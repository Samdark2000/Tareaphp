...
class Utilities
{
    public $characterTypeList = [1 => "Acero", 2 => "Agua", 3 => "Bicho", 4 => "Drago", 5 => "Electrico", 6 => "Fantasma", 7 => "Fuego", 8 => "Hada", 9 => "Hielo", 10 => "Lucha", 11 => "Planta", 12 => "Roca", 13 => "Veneno", 14 => "Volador", 15 => "Siniestro",];
